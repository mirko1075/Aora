      ...
      <div className="scroll-container">
        <ul>
          {props.user[0].scheduledClasses.map((oneScheduledClass, i) => {
            return !props.user[0].scheduledClasses ? (
              ...
              <li key={i}>
                {
                  ...
                  i > 0 &&
                  props.user[0].scheduledClasses[i].scheduled.getDay() ===
                ...
                >
                  ...
                  <div>
                    <h3>
                      {addZeroBefore(oneScheduledClass.scheduled.getHours())}:
                      {addZeroBefore(oneScheduledClass.scheduled.getMinutes())}{" "}
                      | {oneScheduledClass.classType}
                    </h3>
                    <p className="small-info">
                      {oneScheduledClass.duration} min. |{" "}
                      {oneScheduledClass.trainer[0].name}{" "}
